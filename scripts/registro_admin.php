<?php
	include("../scripts/conexion.php");
		...
		mysql_query("INSERT INTO empleado (idempleado,nombre_emp,ap_paterno_emp,ap_materno_emp,rfc_emp,sexo,fecha_nac_emp,iduser,estado_emp) values ('10','$nombre_admin','$ap_pat_admin','$ap_mat_admin','$rfc_admin','1','$fecha_nac_admin','1','1')",$conexion) or die (mysql_error()."ERROR");
